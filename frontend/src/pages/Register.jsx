    ...
    <div className="auth-screen">
      <section className="auth-context">
        <div>
          ...
          <p className="page-kicker">Akun siswa</p>
        ...
        <div className="auth-proof">
          <div className="auth-proof-item">Gunakan nama dan email aktif agar admin mudah memverifikasi laporan.</div>
          <div className="auth-proof-item">Setelah terdaftar, laporanmu tersimpan di daftar pengaduan pribadi.</div>
        </div>
      </section>
