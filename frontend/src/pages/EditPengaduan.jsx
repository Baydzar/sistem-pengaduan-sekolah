  ...
  return (
    <div className="page-wrap">
      <header className="page-head">
        <div>
          <p className="page-kicker">Revisi laporan</p>
      ...
      <form onSubmit={handleSubmit} className="panel p-6 page-wrap-narrow form-grid">
        ...
        <div className="mb-4">
          ...
          <input type="file" accept="image/jpeg,image/png,image/jpg"
            ...
            className="w-full text-sm text-[color:var(--color-ink-2)]" />
          <p className="helper-text">Maksimal 2MB, format JPG atau PNG.</p>
          {data?.gambar && !gambar && (
            <img src={`http://localhost:5000/uploads/${data.gambar}`}
              alt="Foto saat ini" className="mt-2 max-h-32 rounded-[var(--radius-card)] object-contain border border-[color:var(--color-rule)]" />
          )}
        </div>
